...
export const _homePlans = [...Array(3)].map((_, index) => ({
  ...
  icons: [
    BASE_PATH_APPS + "/assets/icons/platforms/ic_figma.svg",
    BASE_PATH_APPS + "/assets/icons/platforms/ic_js.svg",
    BASE_PATH_APPS + "/assets/icons/platforms/ic_ts.svg",
  ],
}));
...
export const _testimonials = [
  ...
  },
  {
    ...
    content: `It's a very good demo and we are really liking the product . We've done some things, like migrate to TS and implementing a react useContext api, to fit our job methodology but the product is one of the best in terms of design and application architecture. The team did a really good job.`,
  },
  {
  ...
  },
  {
    ...
    content: `CEO of Codealy.io here. We’ve built a developer assessment platform that makes sense - tasks are based on git repositories and run in virtual machines. We automate the pain points - storing candidates code, running it and sharing test results with the whole team, remotely. Bought this template as we need to provide an awesome demo for our early customers. I am super happy with purchase. The code is just as good as the design. Thanks!`,
  },
];
