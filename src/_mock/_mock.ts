...
export const _mock = {
  ...
  image: {
    cover: (index: number) =>
      `${BASE_PATH_APPS}/assets/images/cover/cover_${index + 1}.png`,
    avatar: (index: number) =>
      `${BASE_PATH_APPS}/assets/images/avatar/avatar_${index + 1}.png`,
    travel: (index: number) =>
      `${BASE_PATH_APPS}/assets/images/travel/travel_${index + 1}.png`,
    company: (index: number) =>
      `${BASE_PATH_APPS}/assets/images/company/company_${index + 1}.png`,
    product: (index: number) =>
      `${BASE_PATH_APPS}/assets/images/m_product/product_${index + 1}.png`,
    portrait: (index: number) =>
      `${BASE_PATH_APPS}/assets/images/portrait/portrait_${index + 1}.png`,
  },
};
