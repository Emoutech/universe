...
const CATEGORIES = [
  {
    ...
    icon: BASE_PATH_APPS + "/assets/icons/faqs/ic_account.svg",
    href: "#",
  },
  {
    label: "Payment",
    icon: BASE_PATH_APPS + "/assets/icons/faqs/ic_payment.svg",
    href: "#",
  },
  {
    label: "Delivery",
    icon: BASE_PATH_APPS + "/assets/icons/faqs/ic_delivery.svg",
    href: "#",
  },
  {
    label: "Problem with the Product",
    icon: BASE_PATH_APPS + "/assets/icons/faqs/ic_package.svg",
    href: "#",
  },
  {
    label: "Return & Refund",
    icon: BASE_PATH_APPS + "/assets/icons/faqs/ic_refund.svg",
    href: "#",
  },
  {
    label: "Guarantees and assurances",
    icon: BASE_PATH_APPS + "/assets/icons/faqs/ic_assurances.svg",
    href: "#",
  },
];
